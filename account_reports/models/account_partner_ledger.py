...
class ReportPartnerLedger(models.AbstractModel):
    ...
    def _get_columns_name(self, options):
        ...
        if self.user_has_groups('base.group_multi_currency'):
            ...
            columns.append({'name': _('Line Currency'), 'class': 'number'})
    ...
    def _group_by_partner_id(self, options, line_id):
        ...
        exch_code = self.env['res.company'].browse(context['company_ids']).mapped('currency_exchange_journal_id')
        if exch_code:
            base_domain += ['!', '&', '&', '&', ('credit', '=', 0.0), ('debit', '=', 0.0), ('amount_currency', '!=', 0.0), ('journal_id.id', 'in', exch_code.ids)]
        ...
        for partner in sorted_partners:
            ...
            if 'partner_' + str(partner.id) in options.get('unfolded_lines') or unfold_all:
                ...
                for line in amls:
                    ...
                    if self.user_has_groups('base.group_multi_currency'):
                        currency_id = line.currency_id or self.env.user.company_id.currency_id
                        ...
                        domain_columns.append(currency_id.name)
