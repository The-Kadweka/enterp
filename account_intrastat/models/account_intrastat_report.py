...
class IntrastatReport(models.AbstractModel):
    ...
    def _build_query(self, date_from, date_to, journal_ids, invoice_types=None):
        ...
        params = {
            'import_merchandise_code': _merchandise_import_code.get(self.env.user.company_id.country_id.code, '29'),
            'export_merchandise_code': _merchandise_export_code.get(self.env.user.company_id.country_id.code, '19'),
